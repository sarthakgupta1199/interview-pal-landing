...
const VideoReviews = () => {
  ...
  return <section id="reviews" className="py-20 bg-background">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="mb-4">Get 2x more final calls</h2>
        ...
        <div className="relative max-w-7xl mx-auto">
          {/* Scroll buttons */}
          <button onClick={() => scroll('left')} className="absolute left-0 top-1/2 -translate-y-1/2 z-10 w-12 h-12 bg-background/95 backdrop-blur-sm border border-border rounded-full flex items-center justify-center shadow-soft-lg hover:bg-muted/50 transition-colors">
          ...
          <button onClick={() => scroll('right')} className="absolute right-0 top-1/2 -translate-y-1/2 z-10 w-12 h-12 bg-background/95 backdrop-blur-sm border border-border rounded-full flex items-center justify-center shadow-soft-lg hover:bg-muted/50 transition-colors">
          ...
          <div ref={scrollContainerRef} className="flex gap-6 overflow-x-auto scrollbar-hide scroll-smooth px-12" style={{
          scrollbarWidth: 'none',
          msOverflowStyle: 'none'
        }}>
            {reviews.map(review => <div key={review.id} className="flex-none w-80">
                <div className="bg-gradient-card rounded-2xl overflow-hidden shadow-soft-lg border border-border group hover:shadow-soft-xl transition-all duration-300">
                  ...
                  <div className="relative aspect-video bg-muted/20">
                    <img src={review.thumbnail} alt={`${review.name} video review`} className="w-full h-full object-cover" />
                  ...
                  <div className="p-6">
                    <div className="flex items-center gap-3 mb-4">
                      <img src={review.thumbnail} alt={review.name} className="w-12 h-12 rounded-full object-cover" />
