    ...
    <section id="testimonials" className="py-24 px-4 bg-muted/30">
      <div className="container mx-auto">
        <div className="text-center mb-16">
          <h2 className="mb-6 font-manrope">From practice to job offer</h2>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Candidates who practiced here got more final calls. Watch short stories from users who turned practice into offers.
          </p>
        </div>
        ...
        <div className="relative mb-12">
          ...
          >
            {testimonials.map((testimonial) => (
              <Card key={testimonial.id} className="flex-shrink-0 w-80 bg-card hover:shadow-soft-lg transition-all duration-300 group">
